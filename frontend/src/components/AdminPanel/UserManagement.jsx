        ...
        <div>
            ...
            <table className="management-table">
                ...
                <tr>
                    ...
                    <th className="sortable" onClick={() => handleSort('imie')}>Imię i Nazwisko</th>
                    <th className="sortable" onClick={() => handleSort('email')}>Email</th>
                    <th className="sortable" onClick={() => handleSort('rola')}>Rola</th>
                ...
                {users.map(user => (
                    <tr key={user.id}>
                        ...
                        <td>
                            <button className="action-btn edit-btn" onClick={() => handleEditClick(user.id)}>Szczegóły</button>
                        </td>
                    </tr>
                ))}
                </tbody>
